...
public class BufferListOptionPane extends AbstractOptionPane {
	...
	public void _init() {
		...
		rbTextClipStart = new JRadioButton(jEdit.getProperty("options.bufferlist.textClipping.start"));
		...
		switch(textClipping) {
			case 0:          rbTextClipNone.setSelected(true); break;
			case 1: default: rbTextClipStart.setSelected(true); break;
			case 2:          rbTextClipEnd.setSelected(true); break;
		}
